...
directories = {
    ...
    [path, filesep, '<subject>'], 'Put processed datasets and parameters here'; ...
    % Directory for raw data
    [path, filesep, '<subject>', filesep, 'Raw data'], 'Put raw data and ground reference here'; ...
    % Directory for events visualization
    [path, filesep, 'Events', filesep, '<subject>'], 'Events visualization will be saved here'; ...
    ...
    % Directory for normalization visualization
    [path, filesep, 'Normalization', filesep, '<subject>'], 'Normalization visualization will be saved here'; ...
